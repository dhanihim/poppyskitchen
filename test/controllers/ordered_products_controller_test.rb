...
class OrderedProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordered_product" do
    assert_difference('OrderedProduct.count') do
      post ordered_products_url, params: { ordered_product: { description: @ordered_product.description, price: @ordered_product.price, profit: @ordered_product.profit, total: @ordered_product.total } }
    end
  ...
  test "should update ordered_product" do
    patch ordered_product_url(@ordered_product), params: { ordered_product: { description: @ordered_product.description, price: @ordered_product.price, profit: @ordered_product.profit, total: @ordered_product.total } }
