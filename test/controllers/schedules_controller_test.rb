...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { dateclose: @schedule.dateclose, dateopen: @schedule.dateopen } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { dateclose: @schedule.dateclose, dateopen: @schedule.dateopen } }
